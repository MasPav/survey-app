    ...
    <div class="top-content">
        ...
        <div class="container">
            ...
            <div style="height: 60vh; margin-top: auto; margin-bottom: auto; padding-top: 15%;">
                ...
                <p><strong>Thank you for taking the time to complete this survey. <br> We truly value the information
                        you have provided.</strong></p>
            ...
            <div style="height: 60vh; margin-top: auto; margin-bottom: auto; padding-top: 15%;">
                ...
                <p><strong>Oops, something went wrong.<br>Feel free to contact us on <a
                            href="mailto:ernest.okyere-twum@parisdescartes.fr"
                            style="color: blue;"><em>ernest.okyere-twum@parisdescartes.fr</em></a></strong></p>
            </div>
            @else
            <div class="row">
            ...
            <div class="row">
                <div class="pre-form-settings">
                    ...
                    <div style="color: whitesmoke; width: 24%; margin-left: auto; margin-right: auto; display:none;"
                        class="age-entry">
                        <div class="form-group">
                            <label for="age">Age</label>
                            <input type="number" class="form-control" id="age" placeholder="Your age" min="18" />
                            <small style="color: #f0ad4e" id="age-error"><strong>Sorry, you are not allowed to continue
                                    if less than 18 years.</strong></small>
                        </div>
                        <button class="btn btn-primary proceed-btn" onclick="proceedToForm()">Proceed <i
                                class="fa fa-caret-right" style="margin-left: 2px;"></i></button>
                    </div>
                </div>
                    ...
                    <form role="form" action="{{ route('submitForm') }}" method="post" class="f1 ">
                        ...
                        <div class="f1-steps">
                            <div class="f1-progress">
                                <div class="f1-progress-line" data-now-value="5.66" data-number-of-steps="7"
                                    style="width: 5.66%;">
                                </div>
                            </div>
                        ...
                        <div class="form-wrapper">
                            ...
                            <fieldset class="bioSection">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" id="education" name="bioInfo[education]"
                                            onchange="toggleDropdownOtherText(event, $(this))">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="profession"
                                            placeholder="Your Answer" name="bioInfo[profession]" />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="language">Mother Tongue</label>
                                        <select class="form-control" id="language" name="bioInfo[language]"
                                            onchange="toggleDropdownOtherText(event, $(this))">
                                ...
                                <div class="row begin-test-div">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <p>You will see a list of 9 symbols that each matches a number. One of the
                                                symbols will also be
                                                inside a blue box. Tap the number of the symbol that matches the one
                                                inside the box. Use only
                                                the number keys lined in the row. Be as accurate and as fast as you can.
                                            </p>
                                            <button type="button" class="btn btn-primary" onclick="onBeginTest()">Begin
                                                Test</button>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-xs-6 col-md-4">
                                                    <div class="panel panel-default">
                                                        <div class="panel-body text-center">
                                                            <i class="fas elected-symbol-icon"
                                                                data-elected-symbol-value=""></i>
                                            ...
                                            <div class="row" style="margin-top: 50px;">
                                                <ul class="list-inline symbol-list" style="text-align: center;">
                                                    <li>
                                                        ...
                                                        <button type="button" onclick="onSelectSymbol('minus')"
                                                            class="btn btn-primary">1</button>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-equals"
                                                            style="display: block; text-align: center;"></i>
                                                        <button type="button" onclick="onSelectSymbol('equals')"
                                                            class="btn btn-primary">2</button>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-times"
                                                            style="display: block; text-align: center;"></i>
                                                        <button type="button" onclick="onSelectSymbol('times')"
                                                            class="btn btn-primary">3</button>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-greater-than"
                                                            style="display: block; text-align: center;"></i>
                                                        <button type="button" onclick="onSelectSymbol('greater-than')"
                                                            class="btn btn-primary">4</button>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-divide"
                                                            style="display: block; text-align: center;"></i>
                                                        <button type="button" onclick="onSelectSymbol('divide')"
                            ...
                            <fieldset class="wordsSection">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="writeManyWords">Write as many words as possible
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="writeManyLetters">Write as many words as possible
                                        beginning with LETTER-M
                                        in 60 seconds. Separate them with commas</label>
                                    <label for="writeManyLetters">Write as many words as possible beginning with
                                        LETTER-P
                                        in 60 seconds. Separate them with commas</label>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    ...
                                                    (e.g. daytime fatigue, mood, ability to function at work/daily
                                                    chores, concentration, memory,
                                                    mood etc) CURRENTLY
                                                </td>
                                                <td class="text-center">
                                                    <label class="radio-inline">
                                            ...
                                            <tr>
                                                <td>
                                                    How NOTICEABLE to others do you think your sleep problems is in
                            ...
                            <fieldset style="width: 80%;" class="activitySection">
                                <div class="form-group firstSet">
                                    ...
                                    <label class="radio-inline" for="playVideoGameyes">
                                        <input type="radio" name="activity[Do you play video game]"
                                            id="playVideoGameyes" value="Yes"
                                ...
                                <div class="form-group secondSet">
                                    ...
                                    <label class="radio-inline" for="useTheInternetyes">
                                        <input type="radio" name="activity[Do you use the internet]"
                                            id="useTheInternetyes" value="Yes"
                                            onclick="toggleConditionalDivs(event, $(this))" />
                                        <span>Yes</span>
                                    </label>
                                ...
                                <div style="overflow-x: auto;" class="conditionalDivs">
                                    ...
                                    <div class="form-group row col-md-12">
                                        <h4>What activities do you often engage on the internet. Select as many as
                                            applicable</h4>
                                        <div class="checkbox">
                                            <label><input type="checkbox"
                                        ...
                                        <div class="checkbox">
                                            <label><input type="checkbox"
                                                    name="activity[What activities do you often engage on the internet. Select as many as applicable][]"
                                                    value="Health related issues"><span>Health related
                                                    issues</span></label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox"
                                ...
                                <div class="form-group thirdSet">
                                    <label>Have you noticed any physical, psychological, academic or work effects on you
                                        due to video game
                                    ...
                                    <label class="radio-inline" for="gamePlayEffectyes">
                                        <input type="radio"
                                            ...
                                            id="gamePlayEffectyes" value="Yes"
                                            onclick="toggleConditionalDivs(event, $(this))" />
                                        <span>Yes</span>
                                    </label>
                                ...
                                <div class="form-group row col-md-12 conditionalDivs">
                                    <h4>Are the following some of the effects as a result of video game playing or
                                        internet use. Select as
                                    ...
                                    <div class="checkbox">
                                        <label><input type="checkbox"
                                                name="activity[Are the following some of the effects as a result of video game playing or internet use. Select as many as applicable][]"
                                                value="Problem solving skills"><span>Problem solving
                                                skills</span></label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox"
                                                name="activity[Are the following some of the effects as a result of video game playing or internet use. Select as many as applicable][]"
                                                value="Improved decision skills"><span>Improved decision
                                                skills</span></label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value="Other"
